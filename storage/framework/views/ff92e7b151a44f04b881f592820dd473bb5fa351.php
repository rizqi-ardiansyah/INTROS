...
<!-- Site Icons -->
<link rel="shortcut icon" href="images/intros.png" type="image/x-icon" />
<link rel="apple-touch-icon" href="images/intros.png">
...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a class="active" href="case-study">Projek</a></li>
    ...
    <div id="testimonials" class="section wb">
        <div class="container">
            <div class="section-title text-center ">
                <h3>Tanggapan Client</h3>
                <p class="lead ">Terima kasih banyak kami ucapkan kepada para client atas kepercayaannya. <br>Kami akan selalu mengevaluasi dari kritik dan saran yang diberikan.</p>
            </div>
            <!-- end title -->
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="testi-carousel owl-carousel owl-theme">
                        ...
                        <?php $__currentLoopData = $tanggapans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tanggapan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                ...
                                <h4><?php echo e($tanggapan['nama']); ?><small><?php echo e($tanggapan['email']); ?></small></h4>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intros\resources\views/case-study.blade.php ENDPATH**/ ?>